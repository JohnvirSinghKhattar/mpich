...
void ADIOI_JULEA_WriteStrided(ADIO_File fd, const void *buf, int count,
                            MPI_Datatype datatype, int file_ptr_type,
...
/* offset is in units of etype relative to the filetype. */
    ...
    static char myname[] = "ADIOI_JULEA_WRITESTRIDED";
...
/* if atomicity is true, lock the region to be accessed */
        ...
        if (err == -1) {
            *error_code = MPIO_Err_create_code(MPI_SUCCESS,
                                               ...
                                               myname, __LINE__,
                                               MPI_ERR_IO,
                                               "ADIOI_JULEA_WriteStrided: ROMIO tries to optimize this access by doing a read-modify-write, but is unable to read the file. Please give the file read permission and open it with MPI_MODE_RDWR.",
                                               0);
            goto fn_exit;
        }
